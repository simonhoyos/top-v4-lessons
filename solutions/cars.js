...
// function bmwSum() {
  // const filteredCars = cars.filter(car => car.brand.toLowerCase() === 'bmw');
  // const priceArray = filteredCars.map(car => car.price);
  // const sumOfPrices = priceArray.reduce((acc, price) => acc + price, 0);

  // return sumOfPrices;
//   return cars
//     .filter(car => car.brand.toLowerCase() === 'bmw')
//     .map(car => car.price)
...
function bmwSum(array){
  return array
    .reduce((acu,cur) => cur.brand === 'BMW' ? acu + cur.price : acu, 0);
...
//     .filter(car=>car.brand==='BMW')
//     .reduce((acu,cur)=>{
//       console.log(acu['priceBMW'])
//       if(acu['priceBMW']!==undefined){
//           console.log("Existe: " + cur.price)
//           acu['priceBMW']+=cur.price;
//           acu['price']+=cur.price;
//       } else {
//           console.log(acu)
//           console.log(acu['priceBMW'])
//           console.log("No existe: "+cur.price)
//           acu['priceBMW']=cur.price;
//           acu['price']=cur.price;
//       }
//       return acu;
